...
func newConsumer(conf *cfg.ClientConfig) (c *consumer, err error) {
	// Create service backend
	c.service, err = createServices(conf.ServiceConfig)
	if err != nil {
		return nil, err
	}
...
func createServices(conf cfg.ServiceConfig) (services.FanOutService, error) {
